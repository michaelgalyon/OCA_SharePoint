...
import { IRecentDocsProps } from './IRecentDocsProps';
import { IRecentDocsState } from './IRecentDocsState';
...
export default class RecentDocuments extends React.Component<IRecentDocsProps, IRecentDocsState> {
