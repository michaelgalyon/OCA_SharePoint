...
import { ITeamCollabsProps } from './ITeamCollabsProps';
import { ITeamCollabsState } from './ITeamCollabsState';
...
export default class TeamCollaborations extends React.Component<ITeamCollabsProps, ITeamCollabsState> {
    ...
    public render(): React.ReactElement<ITeamCollabsProps> {
