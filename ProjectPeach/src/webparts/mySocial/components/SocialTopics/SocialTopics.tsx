...
import { ISocialTopicsProps } from './ISocialTopicsProps';
import { ISocialTopicsState } from './ISocialTopicsState';
...
export default class SocialTopics extends React.Component<ISocialTopicsProps, ISocialTopicsState> {
    ...
    public render(): React.ReactElement<ISocialTopicsProps> {
