...
import { ISocialCollabsProps } from './ISocialCollabsProps';
import { ISocialCollabsState } from './ISocialCollabsState';
...
export default class SocialCollaborations extends React.Component<ISocialCollabsProps, ISocialCollabsState> {
    ...
    public render(): React.ReactElement<ISocialCollabsProps> {
