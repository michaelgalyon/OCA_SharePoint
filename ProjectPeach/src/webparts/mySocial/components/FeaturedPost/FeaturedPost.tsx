...
import { IFeaturedPostProps } from './IFeaturedPostProps';
import { IFeaturedPostState } from './IFeaturedPostState';
...
export default class FeaturedPost extends React.Component<IFeaturedPostProps, IFeaturedPostState> {
    ...
    public render(): React.ReactElement<IFeaturedPostProps> {
