...
import { IExpensesProps } from './IExpensesProps';
import { IExpensesState } from './IExpensesState';
...
export default class Expenses extends React.Component<IExpensesProps, IExpensesState> {
