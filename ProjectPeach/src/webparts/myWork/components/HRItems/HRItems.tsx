...
import { IHRItemsProps } from './IHRItemsProps';
import { IHRItemsState } from './IHRItemsState';
...
export default class HRItems extends React.Component<IHRItemsProps, IHRItemsState> {
    ...
    public render(): React.ReactElement<IHRItemsProps> {
