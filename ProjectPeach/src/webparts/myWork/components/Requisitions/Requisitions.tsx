...
import { IRequisitionsProps } from './IRequisitionsProps';
import { IRequisitionsState } from './IRequisitionsState';
...
export default class Requisitions extends React.Component<IRequisitionsProps, IRequisitionsState> {
    ...
    public render(): React.ReactElement<IRequisitionsProps> {
