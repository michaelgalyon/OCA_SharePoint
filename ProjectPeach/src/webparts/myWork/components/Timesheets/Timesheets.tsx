...
import { ITimesheetsState } from './ITimesheetsState';
...
export default class Timesheets extends React.Component<ITimesheetsProps, ITimesheetsState> {
    ...
    public render(): React.ReactElement<ITimesheetsProps> {
